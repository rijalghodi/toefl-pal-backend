...
export class CreateFileTableAndAddAudioColumnsInFormTable1725613837169
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "file" ("id" character varying NOT NULL, "filename" varchar,  "url" varchar NOT NULL, "mime_type" varchar, "size" integer, CONSTRAINT "PK_36b46d232307066b3a2c9ea3a1d" PRIMARY KEY ("id"))`,
    );

    await queryRunner.query(
      `ALTER TABLE "form" ADD "instruction_audio_id" uuid`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "form" DROP COLUMN "closing_audio_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "form" DROP COLUMN "instruction_audio_id"`,
    );
